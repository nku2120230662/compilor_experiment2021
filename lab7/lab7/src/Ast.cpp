...
SymbolEntry *_0se = new ConstantSymbolEntry(IntType::get(32), 0);
...
void BinaryExpr::genCode()
{
    ...
    else if(op >= L && op <= NE)
    {
        ...
        {
        case L:
            opcode = CmpInstruction::LT;
            break;
        case G:
            opcode = CmpInstruction::GT;
            break;
        case LE:
...
void DeclStmt::genCode()
{
    ...
    if(se->isGlobal())
    {
        ...
        if (initVal)
        {
            ...
            new MovInstruction(dynamic_cast<IdentifierSymbolEntry *>(id->getSymPtr())->getAddr(), initVal->getOperand(), bb, 1);
        }
        else{
             BasicBlock *bb = builder->getUnit()->getGlobalBB();
