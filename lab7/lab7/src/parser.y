...
%nterm <stmttype> Stmts Stmt AssignStmt BlockStmt IfStmt ReturnStmt DeclStmt FuncDef ExprStmt ContinueStmt BreakStmt
...
ExprStmt
    ...
    ;
BreakStmt
    : BREAK SEMICOLON{$$ = new BlankStmt();}
    ;
ContinueStmt
    : CONTINUE SEMICOLON{$$ = new BlankStmt();}
    ;
BlankStmt
    : SEMICOLON {
        $$ = new BlankStmt();
